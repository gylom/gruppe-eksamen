...
{
    /// <inheritdoc />
    public partial class InitialMatlager : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Brand = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StandardQuantity = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingListItems_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingListItems_MeasurementUnits_MeasurementUnitId",
                        column: x => x.MeasurementUnitId,
                        principalTable: "MeasurementUnits",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShoppingListItems_ProductTypes_ProductTypeId",
                        column: x => x.ProductTypeId,
                        principalTable: "ProductTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HiddenRecipes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HiddenRecipes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HiddenRecipes_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RecipeIngredients_ProductTypes_ProductTypeId",
                        column: x => x.ProductTypeId,
                        principalTable: "ProductTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddedByUserId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryItems_AspNetUsers_AddedByUserId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryItems_MeasurementUnits_MeasurementUnitId",
                        column: x => x.MeasurementUnitId,
                        principalTable: "MeasurementUnits",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HiddenRecipes_RecipeId",
                table: "HiddenRecipes",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_HiddenRecipes_UserId",
                table: "HiddenRecipes",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_AddedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_MeasurementUnitId",
                table: "InventoryItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeIngredients_ProductTypeId",
                table: "RecipeIngredients",
                column: "ProductTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingListItems_HouseholdId",
                table: "ShoppingListItems",
                column: "HouseholdId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingListItems_MeasurementUnitId",
                table: "ShoppingListItems",
                column: "MeasurementUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingListItems_ProductTypeId",
                table: "ShoppingListItems",
                column: "ProductTypeId");
        }
